      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
          <div className="max-w-xl">
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-zinc-200 via-zinc-100 to-white">UMKM KitStudio</h1>
          ...
          <form onSubmit={(e) => { e.preventDefault(); setSent(true); setTimeout(()=>setSent(false), 2000); }} className="mt-6 flex gap-2 max-w-md">
            ...
            <button className="rounded-md bg-gradient-to-r from-primary to-white/20 px-4 py-2 font-semibold text-primary-foreground">{sent ? "Terima kasih!" : "Notify me"}</button>
          </form>
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="rounded-2xl bg-gradient-to-br from-slate-900 to-slate-950 p-6 shadow-xl w-full max-w-md">
            <div className="h-64 w-full bg-gradient-to-tr from-zinc-800 via-zinc-900 to-black rounded-lg" />
